      ...
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-slate-500 sm:mb-0 ">
            ...
            <li>
              <Link href="/about/privacy" className="mr-4 hover:underline md:mr-6">Privacy Policy</Link>
            </li>
            <li>
              <Link href="/about/documentation" className="mr-4 hover:underline md:mr-6 ">Documentation</Link>
            </li>
            <li>
        ...
        <span className="block text-sm text-slate-500 sm:text-center">© 2023 <Link href="/" className="hover:underline">Oscar Ox</Link>. All Rights Reserved.</span>
      </div>
    </footer>
